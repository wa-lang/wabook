...
const giscus_data_repo = "{{.DataRepo}}";
const giscus_data_repo_id = "{{.DataRepoId}}";
const giscus_data_category = "{{.DataCategory}}";
const giscus_data_category_id = "{{.DataCategoryId}}";
